 ...
 * @date 2018/1/10
 */
public abstract class LongRepository<S extends LongAggregateSnapshot, T extends LongAggregateRoot<S>> implements Repository<T, Long> {

    private LongSnapshotStorage<S> storage;
     ...
     * @param storage
     */
    protected void injectStorage(LongSnapshotStorage<S> storage) {

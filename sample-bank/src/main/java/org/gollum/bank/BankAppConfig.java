...
import org.gollum.core.commanding.AsyncCommandBus;
...
public class BankAppConfig {
    ...
    CommandBus commandBus(ApplicationContext ctx) {
        SimpleCommandBus bus = new /*SimpleCommandBus()*/AsyncCommandBus();
    ...
    EventBus eventBus(ApplicationContext ctx) {
        ...
        bus.register(BankAccountCreated.class, ctx.getBean(BankAccountCreatedLoggingHandler.class));
        ...
        bus.register(DepositTransactionCompleted.class, ctx.getBean(DepositTransactionCompletedLoggingHandler.class));
